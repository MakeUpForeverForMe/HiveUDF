...
//    System.out.println(new GetDateMin().evaluate("2020-06-24", "2000-06-01"));
    ...
    public void dataIsEmpty1() {
        ...
        System.out.println(new IsEmpty().evaluate(null, ""));
    ...
    public void testIsEmtyGenericUDF() throws HiveException {
        ...
        JavaBooleanObjectInspector javaBooleanObjectInspector = PrimitiveObjectInspectorFactory.javaBooleanObjectInspector;
        JavaStringObjectInspector javaStringObjectInspector = PrimitiveObjectInspectorFactory.javaStringObjectInspector;
        ObjectInspector initialize = emptyGenericUDF.initialize(new ObjectInspector[]{javaStringObjectInspector});
        System.out.println(initialize.getCategory());

        Object object = "aa";

        Object evaluate = emptyGenericUDF.evaluate(new DeferredObject[]{new DeferredJavaObject(object)});
